...
const struct MartItem sPokeathlonShopSunday[] = {
    { ITEM_RED_APRICORN,   20   },
    { ITEM_BLUE_APRICORN,  20   },
    { ITEM_BLACK_APRICORN, 20   },
    { ITEM_MOOMOO_MILK,    10   },
    { ITEM_KINGS_ROCK,     300  },
    { ITEM_HEART_SCALE,    100  },
    { ITEM_FULL_RESTORE,   50   },
    { ITEM_NUGGET,         50   },
    { ITEM_SUN_STONE,      300  },
    { ITEM_FIRE_STONE,     250  },
    { ITEM_SHINY_STONE,    300  },
    { ITEM_DAWN_STONE,     300  },
    { 0xFFFF,              0    },
};
...
const struct MartItem sPokeathlonShopTuesday[] = {
    { ITEM_YELLOW_APRICORN, 20   },
    { ITEM_PINK_APRICORN,   20   },
    { ITEM_WHITE_APRICORN,  20   },
    { ITEM_MOOMOO_MILK,     10   },
    { ITEM_FIRE_STONE,      250  },
    { ITEM_PP_UP,           100  },
    { ITEM_FULL_RESTORE,    50   },
...
const struct MartItem sPokeathlonShopWednesday[] = {
    ...
    { ITEM_HEART_SCALE,    100  },
    { ITEM_FULL_RESTORE,   50   },
    { ITEM_DRAGON_SCALE,   250  },
    { ITEM_THUNDER_STONE,  250  },
    { ITEM_MOON_STONE,     300  },
    { ITEM_SHINY_STONE,    300  },
    { ITEM_DAWN_STONE,     300  },
    { 0xFFFF,              0    },
